...
export default function Footer({currentPage}) {
  return (
    <>
        ...
        <SmallBlock src={iAmHope} href="https://www.iamhope.org.nz/" className="bg-white lg:col-span-3" />
        <SmallBlock
                src={gumbootFriday}
                href="https://www.gumbootfriday.org.nz/"
                className="bg-white lg:col-span-3"
            />
        <SmallBlock href="https://www.instagram.com/runningforsal/" className="text-6xl bg-gradient-to-br from-purple-800 to-orange-400 col-span-6 lg:col-span-3">
                <SiInstagram />
        </SmallBlock>
